(function () {
    ...
    myConnector.getData = function(table, doneCallback) {
        $.getJSON("https://demo.incarnus.com:8850/thirdparty/reportingservice/reportingservice/patientreports/getopdvisittrends/2016-01-01/2016-10-01", function(resp) {
            var data = resp.opdvisittrends,
                tableData = [];
