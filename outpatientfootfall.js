(function () {
    ...
    myConnector.getData = function(table, doneCallback) {
        $.getJSON("https://demo.incarnus.com:8850/thirdparty/reportingservice/reportingservice/patientreports/getoutpatientfootfall/1000/6/2000-01-01", function(resp) {
